...
<main class="container" style="margin-top:70px">
  ...
  <table style="width:50%">
    ...
    <footer class="foot" id = "temp" >ESP32 Web Page Creation and Data Update Demo</footer>
  ...
  <script type="text/javascript">
        ...
        xhttp.onreadystatechange = function() {
            if (this.readyState == 4) {
                if (this.status == 200) {
                    ...
                    console.error("Error updating slider: " + this.status);
                }
            }
        };
    ...
    function ButtonPress0() {
        ...
        xhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status != 200) {
                console.error("Error toggling button 0: " + this.status);
            }
        };
    ...
    function ButtonPress1() {
        ...
        xhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status != 200) {
                console.error("Error toggling button 1: " + this.status);
            }
        };
    ...
    function process() {
        ...
        setTimeout("process()", 200); // Request updates every 200 milliseconds
    }
